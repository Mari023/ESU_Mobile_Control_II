...
public class Preferences {
    ...
    public void saveLoco(String ID, int nr) {
        ...
        switch (nr) {
            case 2:
                LocoID2 = ID;
                editor.putString(PREFS_LOCOID2, ID);
                break;
            case 3:
                LocoID3 = ID;
                editor.putString(PREFS_LOCOID3, ID);
                break;
            case 4:
                LocoID4 = ID;
                editor.putString(PREFS_LOCOID4, ID);
                break;
            case 5:
                LocoID5 = ID;
                editor.putString(PREFS_LOCOID5, ID);
                break;
            case 6:
                LocoID6 = ID;
                editor.putString(PREFS_LOCOID6, ID);
                break;
            default:
                LocoID = ID;
