...
public class MainActivity extends AppCompatActivity {
     ...
     */
    private final ThrottleFragment.OnThrottleListener mOnThrottleListener = new ThrottleFragment.OnThrottleListener() {
        @Override
     ...
     */
    private final StopButtonFragment.OnStopButtonListener mOnStopButtonListener = new StopButtonFragment.OnStopButtonListener() {
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mThrottlePosition = findViewById(R.id.text_position);
        mThrottlePosition.setText("0");

        mThrottleStep = findViewById(R.id.text_step);
        mThrottlePosition.setText("0");

        mThrottleButtonState = findViewById(R.id.text_button);
        // Set text to default value. We will receive MSG_BUTTON_DOWN if the value changed.
        mThrottleButtonState.setText("UP");

        mStopButtonState = findViewById(R.id.text_stop);
        mStopButtonState.setText("UP");
